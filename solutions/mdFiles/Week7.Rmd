...
```{r}
y == ((2*x) + 0.2) #doesnt' work becuase they are floating 

isTRUE(all.equal(y, ((2*x) + 0.2)))
...
```{r}
str_count(dna1, ("g|c"))/str_length(dna1) != (str_count(dna2, "g")+str_count(dna2,"c"))/str_length(dna2)
```
